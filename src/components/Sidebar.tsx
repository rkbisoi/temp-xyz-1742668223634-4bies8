...
export default function Sidebar({ activeView, onMenuClick }: SidebarProps) {
  ...
  const menuItems: (MenuItem | null)[] = [
    ...
    { icon: Boxes, label: 'Applications', id: 'applications' },
      ...
      <nav className="mt-14">
        {filteredMenuItems.map((item, index) => (
          <button
            ...
            className={`w-full flex flex-col items-center px-3 md:py-[11px] lg:py-[15px] text-white hover:bg-intelQEBlue transition-colors justify-center relative 
