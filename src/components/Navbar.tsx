    ...
    <nav className="bg-white shadow-sm pr-4 fixed right-0 left-0 z-50">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="inline-flex text-[9px] mt-1.5 m text-gray-500">Powered By <img src="../../resource/devops1.JPG" className='h-3 object-cover ml-1'/></p>
        </div>
      ...
      {isDropdownOpen && (
        <div className="absolute right-1 top-12  bg-white p-2 rounded-lg shadow-lg border border-1 border-gray-200">
