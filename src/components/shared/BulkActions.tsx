...
export default function BulkActions({ selectedItems, onAction, actions }: BulkActionsProps) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-intelQEDarkBlue shadow-lg rounded-lg border border-gray-200 px-4 py-2 flex items-center gap-2 z-50">
