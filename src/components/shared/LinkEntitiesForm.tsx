...
import { linkUsersToProjects } from '../../services/userService';
...
export default function LinkEntitiesForm({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const projectIds: number[] = Array.from(selectedIds);
  
      if (sourceType === 'knowledge') {
        await linkKnowledgesToProjects(projectIds, sourceIds);
      } else if (sourceType === 'data') {
        await linkDataToProjects(projectIds, sourceIds);
