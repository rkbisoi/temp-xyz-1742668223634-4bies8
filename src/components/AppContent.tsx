  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ml-[100px]`}>
        <Navbar />
        <main className="flex-1 overflow-auto pt-14 bg-gray-50">
          {state.view === 'dashboard' && <Dashboard />}
          {state.view === 'projects' && !state.projectId && <ProjectList onProjectView={handleProjectView} />}
          ...
          {state.view === 'applications' && !state.applicationId && <ApplicationList onApplicationView={handleApplicationView} projectId={-1} />}
